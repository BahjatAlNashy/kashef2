...
Route::get('/setup-admin', function () {
    try {
        $user = User::first(); // سيجلب أول مستخدم موجود
        if ($user) {
            $user->password = Hash::make('12345678'); // تشفير كلمة المرور الجديدة
            $user->save();
            return "تم تشفير كلمة المرور بنجاح! جرب الدخول الآن بـ: 12345678";
        }
